...
static const FindReplace_struct Model_Name_Samsung[] = {
    ...
    { "SM-G160", "Galaxy Folder2" },
    { "SM-G165", "Galaxy Folder2" },
    ...
    { "SM-L305", "Galaxy Watch7" },
    { "SM-L310", "Galaxy Watch7" },
    { "SM-L315", "Galaxy Watch7" },
    { "SM-L320", "Galaxy Watch8" },
    { "SM-L325", "Galaxy Watch8" },
    { "SM-L330", "Galaxy Watch8" },
    { "SM-L335", "Galaxy Watch8" },
...
void File__Analyze::Streams_Finish_StreamOnly_General_Curate(size_t StreamPos)
{
    ...
    // Model name
    auto ExtractName = [&](size_t Parameter_CompanyName, size_t Parameter_Model, size_t Parameter_Name) {
