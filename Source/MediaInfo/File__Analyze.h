...
public : //TO CHANGE
    ...
    Ztring Details_Get(size_t Level=0) { std::string str; if (Element[Level].TraceNode.Print(Config_Trace_Format, str, Config_LineSeparator.To_UTF8()) < 0) return Ztring(); return Ztring().From_UTF8(str);}
    void   Details_Clear();
protected :
