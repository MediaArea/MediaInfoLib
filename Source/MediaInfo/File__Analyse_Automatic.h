...
enum generic
{
    ...
    Generic_TimeCode_LastFrame,
    Generic_TimeCode_DropFrame,
    Generic_TimeCode_Settings,
    Generic_TimeCode_Source,
    Generic_StreamSize,
...
enum general
{
    ...
    General_Duration_Start_String,
    General_Duration_Start_String1,
    General_Duration_Start_String2,
    General_Duration_Start_String3,
    General_Duration_Start_String4,
    General_Duration_Start_String5,
    General_Duration_End,
    General_Duration_End_String,
    General_Duration_End_String1,
    General_Duration_End_String2,
    General_Duration_End_String3,
    General_Duration_End_String4,
    General_Duration_End_String5,
    ...
    General_Reel,
    General_Reel_Position,
    General_Reel_Position_Total,
    General_Track,
    General_Track_More,
    General_Track_Url,
    General_Track_Sort,
...
enum video
{
    ...
    Video_MasteringDisplay_Luminance_Min,
    Video_MasteringDisplay_Luminance_Max,
    Video_MasteringDisplay_Luminance_Original,
    Video_MasteringDisplay_Luminance_Original_Source,
    Video_MasteringDisplay_Luminance_Original_Min,
    Video_MasteringDisplay_Luminance_Original_Max,
    Video_MaxCLL,
    Video_MaxCLL_Source,
...
enum audio
{
    ...
    Audio_TimeCode_FirstFrame,
    Audio_TimeCode_LastFrame,
    Audio_TimeCode_DropFrame,
    Audio_TimeCode_Settings,
    Audio_TimeCode_Source,
...
enum text
{
    ...
    Text_Duration_Start2End,
    Text_Duration_Start2End_String,
    Text_Duration_Start2End_String1,
    Text_Duration_Start2End_String2,
    Text_Duration_Start2End_String3,
    Text_Duration_Start2End_String4,
    Text_Duration_Start2End_String5,
    Text_Duration_Start_Command,
    Text_Duration_Start_Command_String,
    Text_Duration_Start_Command_String1,
    Text_Duration_Start_Command_String2,
    Text_Duration_Start_Command_String3,
    Text_Duration_Start_Command_String4,
    Text_Duration_Start_Command_String5,
    Text_Duration_Start,
    Text_Duration_Start_String,
    Text_Duration_Start_String1,
    Text_Duration_Start_String2,
    Text_Duration_Start_String3,
    Text_Duration_Start_String4,
    Text_Duration_Start_String5,
    Text_Duration_End,
    Text_Duration_End_String,
    Text_Duration_End_String1,
    Text_Duration_End_String2,
    Text_Duration_End_String3,
    Text_Duration_End_String4,
    Text_Duration_End_String5,
    Text_Duration_End_Command,
    Text_Duration_End_Command_String,
    Text_Duration_End_Command_String1,
    Text_Duration_End_Command_String2,
    Text_Duration_End_Command_String3,
    Text_Duration_End_Command_String4,
    Text_Duration_End_Command_String5,
    ...
    Text_Height,
    Text_Height_String,
    Text_DisplayAspectRatio,
    Text_DisplayAspectRatio_String,
    Text_DisplayAspectRatio_Original,
    Text_DisplayAspectRatio_Original_String,
    Text_FrameRate_Mode,
    Text_FrameRate_Mode_String,
    Text_FrameRate_Mode_Original,
    Text_FrameRate_Mode_Original_String,
    Text_FrameRate,
    ...
    Text_FrameRate_Original_Num,
    Text_FrameRate_Original_Den,
    Text_FrameCount,
    Text_ElementCount,
    ...
    Text_TimeCode_FirstFrame,
    Text_TimeCode_LastFrame,
    Text_TimeCode_DropFrame,
    Text_TimeCode_Settings,
    Text_TimeCode_Source,
    Text_TimeCode_MaxFrameNumber,
    Text_TimeCode_MaxFrameNumber_Theory,
    Text_StreamSize,
    ...
    Text_Encryption,
    Text_Events_Total,
    Text_Events_MinDuration,
    Text_Events_MinDuration_String,
    Text_Events_MinDuration_String1,
    Text_Events_MinDuration_String2,
    Text_Events_MinDuration_String3,
    Text_Events_MinDuration_String4,
    Text_Events_MinDuration_String5,
    Text_Events_PopOn,
    Text_Events_RollUp,
    Text_Events_PaintOn,
    Text_Lines_Count,
...
enum other
{
    ...
    Other_TimeCode_LastFrame,
    Other_TimeCode_DropFrame,
    Other_TimeCode_Settings,
    Other_TimeCode_Stripped,
    Other_TimeCode_Stripped_String,
    Other_TimeCode_Source,
    Other_StreamSize,
...
enum image
{
    ...
    Image_HDR_Format,
    Image_HDR_Format_String,
    Image_HDR_Format_Commercial,
    Image_HDR_Format_Version,
    Image_HDR_Format_Profile,
    Image_HDR_Format_Level,
    Image_HDR_Format_Settings,
    Image_HDR_Format_Compatibility,
    ...
    Image_Active_Width,
    Image_Active_Width_String,
    Image_Active_Height,
    Image_Active_Height_String,
    Image_Active_DisplayAspectRatio,
    Image_Active_DisplayAspectRatio_String,
    Image_ColorSpace,
    ...
    Image_colour_description_present_Source,
    Image_colour_description_present_Original,
    Image_colour_description_present_Original_Source,
    Image_colour_range,
    Image_colour_range_Source,
    Image_colour_range_Original,
    Image_colour_range_Original_Source,
    Image_colour_primaries,
    Image_colour_primaries_Source,
    Image_colour_primaries_Original,
    Image_colour_primaries_Original_Source,
    Image_transfer_characteristics,
    Image_transfer_characteristics_Source,
    Image_transfer_characteristics_Original,
    Image_transfer_characteristics_Original_Source,
    Image_matrix_coefficients,
    Image_matrix_coefficients_Source,
    Image_matrix_coefficients_Original,
    Image_matrix_coefficients_Original_Source,
    Image_MasteringDisplay_ColorPrimaries,
    Image_MasteringDisplay_ColorPrimaries_Source,
    Image_MasteringDisplay_ColorPrimaries_Original,
    Image_MasteringDisplay_ColorPrimaries_Original_Source,
    Image_MasteringDisplay_Luminance,
    Image_MasteringDisplay_Luminance_Source,
    Image_MasteringDisplay_Luminance_Original,
    Image_MasteringDisplay_Luminance_Original_Source,
    Image_MaxCLL,
    Image_MaxCLL_Source,
    Image_MaxCLL_Original,
    Image_MaxCLL_Original_Source,
    Image_MaxFALL,
    Image_MaxFALL_Source,
    Image_MaxFALL_Original,
    Image_MaxFALL_Original_Source,
};
...
enum menu
{
    ...
    Menu_Delay_Source,
    Menu_FrameRate_Mode,
    Menu_FrameRate_Mode_String,
    Menu_FrameRate,
    Menu_FrameRate_String,
    Menu_FrameRate_Num,
    Menu_FrameRate_Den,
    Menu_FrameCount,
