 ...
 */
 ...
 // 
 // Decode AVS3 (T/AI 109/2) according to DVB Bluebook A001
 //
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
static const char* Avs3V_extension_start_code_identifier[]=
{
  ...
  /* 0101 */  "high_dunamic_range_picture_metadata_extension",
  /* 0110 */  "",
...
void File_Avs3V::Streams_Fill()
{
    ...
    if (colour_primaries!=2) Fill(Stream_Video, 0, Video_colour_primaries, Avs3V_colour_primaries(colour_primaries));
    if (transfer_characteristics!=2) Fill(Stream_Video, 0, Video_transfer_characteristics, Avs3V_transfer_characteristics(transfer_characteristics));
    if (matrix_coefficients!=2) Fill(Stream_Video, 0, Video_matrix_coefficients, Avs3V_matrix_coefficients(matrix_coefficients));
    ...
    if (have_MaxFALL) Fill(Stream_Video, 0, Video_MaxFALL, max_picture_average_light_level);
...
void File_Avs3V::video_sequence_start()
{
    ...
    FILLING_BEGIN();
        ...
        Streams[Avs3_Reserved1].Searching_Payload=true, //reserved
        ...
        Streams[Avs3_Reserved2].Searching_Payload=true, //reserved
...
void File_Avs3V::picture_start()
{
    ...
    Element_Info1C((Element_Code==Intra_Picture_Start_Code), __T("I"));
    ...
    if (Element_Code==Inter_Picture_Start_Code)
        Get_S1(2, picture_coding_type,                          "picture_coding_type"); 
    
    Element_Info1(Avs3V_picture_coding_type[picture_coding_type]);
    ...
    FILLING_BEGIN();
        ...
        NextCode_Add(Video_Sequence_Start_Code); //video_sequence_start
        NextCode_Add(Intra_Picture_Start_Code); //picture_start
        NextCode_Add(Inter_Picture_Start_Code); //picture_start
        NextCode_Add(Extension_Start_Code); //extension_start  // PH - AVS3 allows extension data after the picture
