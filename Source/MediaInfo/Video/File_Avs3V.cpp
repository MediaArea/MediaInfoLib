...
static Ztring Avs3V_matrix_coefficients(int8u matrix_coefficients)
{
    ...
    {
        case  8:
        case  9: Mpegv_matrix_coefficients(matrix_coefficients + 1);
...
void File_Avs3V::Streams_Fill()
{
    ...
    if (DMI_Found)
    {
        if (HAVE_HDR10plus_DMI)
            Fill(Stream_Video, 0, Video_HDR_Format_String, "SMPTE ST 2094-40 DMI");
        if ( HAVE_SLHDR2_DMI)
            Fill(Stream_Video, 0, Video_HDR_Format_String, "ETSI TS 103 433-2 DMI");
        if (HAVE_DolbyVision_DMI)
            Fill(Stream_Video, 0, Video_HDR_Format_String, "SMPTE ST 2094-10 DMI");
        if (HAVE_HDRVivid_DMI)
            Fill(Stream_Video, 0, Video_HDR_Format_String, "T/UWA 005.1-2021 DMI");
    }
...
void File_Avs3V::picture_start()
{
    ...
    FILLING_BEGIN();
        ...
        NextCode_Add(Extension_Start_Code); //extension_start  // PH - AVSV allows extension data after the picture
