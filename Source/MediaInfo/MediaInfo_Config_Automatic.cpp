...
void MediaInfo_Config_DefaultLanguage (Translation &Info)
{
    ...
    "ISBN;ISBN\n"
    "ISRC;ISRC\n"
    "JocBalance_FrontBackOverheadFloor;Front/back overhead/floor balance\n"
    "JocBalance_FrontBackListener;Front/back listener balance\n"
    "JocTrim_Center;Center trim\n"
    "JocTrim_Height;Height trim\n"
    "JocTrim_Surround;Surround trim\n"
    "JocTrimMode;Trim mode\n"
    "JocTrimMode0i;Trim mode for 2.0\n"
    "JocTrimMode1i;Trim mode for 5.1\n"
    "JocTrimMode2i;Trim mode for 7.1\n"
    "JocTrimMode3i;Trim mode for 2.1.2\n"
    "JocTrimMode4i;Trim mode for 5.1.2\n"
    "JocTrimMode5i;Trim mode for 7.1.2\n"
    "JocTrimMode6i;Trim mode for 2.1.4\n"
    "JocTrimMode7i;Trim mode for 5.1.4\n"
    "JocTrimMode8i;Trim mode for 7.1.4\n"
    "Keywords;Keywords\n"
...
void MediaInfo_Config_General (ZtringListList &Info)
{
    ...
    "StreamOrder;;;N YIY;;;Stream order in the file for type of stream (base=0)\n"
...
void MediaInfo_Config_Text (ZtringListList &Info)
{
    ...
    "Duration/String5;;;N NT;;;Play time in format : HH:MM:SS.mmm (HH:MM:SS:FF)\n"
    "Duration_Start2End;; ms;N YFY;;;Play time of the stream, in ms\n"
    "Duration_Start2End/String;;;Y NT;;;Play time (formated)\n"
    "Duration_Start2End/String1;;;N NT;;;Play time in format : HHh MMmn SSs MMMms, XX omited if zero\n"
    "Duration_Start2End/String2;;;N NT;;;Play time in format : XXx YYy only, YYy omited if zero\n"
    "Duration_Start2End/String3;;;N NT;;;Play time in format : HH:MM:SS.MMM\n"
    "Duration_Start2End/String4;;;N NT;;;Play time in format : HH:MM:SS:FF, last colon replaced by semicolon for drop Duration;; ms;N YFY;;;Play time of the stream, in ms\n"
    "Duration_Start2End/String5;;;N NT;;;Play time in format : HH:MM:SS.mmm (HH:MM:SS:FF)\n"
    ...
    "Duration_Start_Command/String2;;;N NT;;;Play time in format : XXx YYy only, YYy omited if zero\n"
    "Duration_Start_Command/String3;;;N NT;;;Play time in format : HH:MM:SS.MMM\n"
    "Duration_Start_Command/String4;;;N NT;;;Play time in format : HH:MM:SS:FF, last colon replaced by semicolon for drop Duration;; ms;N YFY;;;Play time of the stream, in ms\n"
    "Duration_Start_Command/String5;;;N NT;;;Play time in format : HH:MM:SS.mmm (HH:MM:SS:FF)\n"
    "Duration_Start;; ms;N YFY;;;Play time of the stream, in ms\n"
    "Duration_Start/String;;;Y NT;;;Play time (formated)\n"
    "Duration_Start/String1;;;N NT;;;Play time in format : HHh MMmn SSs MMMms, XX omited if zero\n"
    "Duration_Start/String2;;;N NT;;;Play time in format : XXx YYy only, YYy omited if zero\n"
    "Duration_Start/String3;;;N NT;;;Play time in format : HH:MM:SS.MMM\n"
    "Duration_Start/String4;;;N NT;;;Play time in format : HH:MM:SS:FF, last colon replaced by semicolon for drop Duration;; ms;N YFY;;;Play time of the stream, in ms\n"
    "Duration_Start/String5;;;N NT;;;Play time in format : HH:MM:SS.mmm (HH:MM:SS:FF)\n"
    "Duration_End;; ms;N YFY;;;Play time of the stream, in ms\n"
    "Duration_End/String;;;Y NT;;;Play time (formated)\n"
    "Duration_End/String1;;;N NT;;;Play time in format : HHh MMmn SSs MMMms, XX omited if zero\n"
    "Duration_End/String2;;;N NT;;;Play time in format : XXx YYy only, YYy omited if zero\n"
    "Duration_End/String3;;;N NT;;;Play time in format : HH:MM:SS.MMM\n"
    "Duration_End/String4;;;N NT;;;Play time in format : HH:MM:SS:FF, last colon replaced by semicolon for drop frame if available\n"
    "Duration_End/String5;;;N NT;;;Play time in format : HH:MM:SS.mmm (HH:MM:SS:FF)\n"
    "Duration_End_Command;; ms;N YFY;;;Play time of the stream, in ms\n"
    "Duration_End_Command/String;;;Y NT;;;Play time (formated)\n"
    "Duration_End_Command/String1;;;N NT;;;Play time in format : HHh MMmn SSs MMMms, XX omited if zero\n"
    "Duration_End_Command/String2;;;N NT;;;Play time in format : XXx YYy only, YYy omited if zero\n"
    "Duration_End_Command/String3;;;N NT;;;Play time in format : HH:MM:SS.MMM\n"
    "Duration_End_Command/String4;;;N NT;;;Play time in format : HH:MM:SS:FF, last colon replaced by semicolon for drop Duration;; ms;N YFY;;;Play time of the stream, in ms\n"
