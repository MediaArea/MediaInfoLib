...
void MediaInfo_Config_DefaultLanguage (Translation &Info)
{
    ...
    "Loudness_MaximumOfRange;Maximum of the loudness range\n"
    "Loudness_MaximumOfRange_Album;Maximum of the loudness range (album)\n"
    ...
    "Loudness_ShortTerm;Short-term loudness\n"
    "Loudness_ShortTerm_Album;Short-term loudness (album)\n"
