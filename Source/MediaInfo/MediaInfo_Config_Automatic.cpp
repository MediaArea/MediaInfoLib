...
void MediaInfo_Config_Format (InfoMap &Info)
{
    ...
    "DTS;;;A;Dts;Digital Theater Systems;dts dtshd;;\n"
    ...
    "FLAC;;;A;Flac;Free Lossless Audio Codec;flac;;https://xiph.org/flac/\n"
    ...
    "Wave;;;A;Riff;;act wav;audio/vnd.wave;\n"
    "Wave64;;;A;Riff;;w64;;\n"
...
void MediaInfo_Config_CodecID_Audio_Riff (InfoMap &Info)
{
    ...
    "BA368D4D-E147-D242-88FC-61654F8C836C;Atrac9;;\n"
...
void MediaInfo_Config_General (ZtringListList &Info)
{
    ...
    "Domain;;;Y YTY;;;Univers movies belong to, e.g. Starwars, Stargate, Buffy, Dragonballs;;Title\n"
    "Collection;;;Y YTY;;;Name of the series, e.g. Starwars movies, Stargate SG-1, Stargate Atlantis, Buffy, Angel;;Title\n"
    "Season;;;Y YTY;;;Name of the season, e.g. Strawars first Trilogy, Season 1;;Title\n"
    "Season_Position;;;Y YIY;;;Number of the Season;;Title\n"
    "Season_Position_Total;;;Y YIY;;;Place of the season e.g. 2 of 7;;Title\n"
    "Movie;;;Y YTY;;;Name of the movie. Eg : Starwars, a new hope;;Title\n"
    "Movie_More;;;Y YTY;;;More infos about the movie;;Title\n"
    "Movie/Country;;;Y YTY;;;Country, where the movie was procuced;;Title\n"
    "Movie/Url;;;Y YT;;;Homepage for the movie;;Title\n"
    "Album;;;Y YTY;;;Name of an audio-album. Eg : The joshua tree;;Title\n"
    "Album_More;;;Y YTY;;;More infos about the album;;Title\n"
    ...
    "Comic_More;;;Y YTY;;;;;Title\n"
    "Comic/Position_Total;;;Y YIY;;;;;Title\n"
    ...
    "Track;;;Y YTY;;;Name of the track. e.g. track1, track 2;;Title\n"
    "Track_More;;;Y YTY;;;More infos about the track;;Title\n"
    ...
    "Original/Album;;;Y YTY;;;Original name of album, serie...;;Title\n"
    "Original/Movie;;;Y YTY;;;Original name of the movie;;Title\n"
    "Original/Part;;;Y YTY;;;Original name of the part in the original support;;Title\n"
    "Original/Track;;;Y YTY;;;Original name of the track in the original support;;Title\n"
    "Compilation;;Yes;N YTY;;;iTunes compilation;;Title\n"
    "Compilation/String;;;Y NT;;;iTunes compilation;;Title\n"
    "Performer;;;Y YTY;;;Main performer/artist of this file;;Entity\n"
    ...
    "Composer/Nationality;;;Y YTY;;;Nationality of the main composer of the item, mostly for classical music.;;Entity\n"
    "Composer/Sort;;;Y YTY;;;;;Entity\n"
    "Arranger;;;Y YTY;;;The person who arranged the piece. e.g. Ravel.;;Entity\n"
    "Lyricist;;;Y YTY;;;The person who wrote the lyrics for a musical item.;;Entity\n"
    "Original/Lyricist;;;Y YTY;;;Original lyricist(s)/text writer(s).;;Entity\n"
    "Conductor;;;Y YTY;;;The artist(s) who performed the work. In classical music this would be the conductor, orchestra, soloists.;;Entity\n"
    ...
    "DirectorOfPhotography;;;Y YTY;;;The name of the director of photography, also known as cinematographer.;;Entity\n"
    "SoundEngineer;;;Y YTY;;;The name of the sound engineer or sound recordist.;;Entity\n"
    "ArtDirector;;;Y YTY;;;The person who oversees the artists and craftspeople who build the sets.;;Entity\n"
    "ProductionDesigner;;;Y YTY;;;The person responsible for designing the Overall visual appearance of a movie.;;Entity\n"
    "Choregrapher;;;Y YTY;;;The name of the choregrapher.;;Entity\n"
    "CostumeDesigner;;;Y YTY;;;The name of the costume designer.;;Entity\n"
    "Actor;;;Y YTY;;;Real name of an actor or actress playing a role in the movie.;;Entity\n"
    "Actor_Character;;;Y YTY;;;Name of the character an actor or actress plays in this movie.;;Entity\n"
    "WrittenBy;;;Y YTY;;;The author of the story or script.;;Entity\n"
    "ScreenplayBy;;;Y YTY;;;The author of the screenplay or scenario (used for movies and TV shows).;;Entity\n"
    ...
    "CoProducer;;;Y YTY;;;The name of a co-producer.;;Entity\n"
    "ExecutiveProducer;;;Y YTY;;;The name of an executive producer.;;Entity\n"
    "MusicBy;;;Y YTY;;;Main music-artist for a movie;;Entity\n"
    "DistributedBy;;;Y YTY;;;Company the item is mainly distributed by ;;Entity\n"
    "OriginalSourceForm/DistributedBy;;;Y YTY;;;Name of the person or organization who supplied the original subjecTY;;Entity\n"
    "MasteredBy;;;Y YTY;;;The engineer who mastered the content for a physical medium or for digital distribution.;;Entity\n"
    "EncodedBy;;;Y YTY;;;Name of the person or organisation that encoded/ripped the audio file.;;Entity\n"
    "RemixedBy;;;Y YTY;;;Name of the artist(s), that interpreted, remixed, or otherwise modified the item.;;Entity\n"
    ...
    "Publisher/URL;;;Y YTY;;;Publishers official webpage.;;Entity\n"
    "Label;;;Y YTY;;;Brand or trademark associated with the marketing of music recordings and music videos.;;Entity\n"
    "Genre;;;Y YTY;;;The main genre of the audio or video. e.g. classical, ambient-house, synthpop, sci-fi, drama, etc.;;Classification\n"
    ...
    "ContentType;;;Y YTY;;;The type of the item. e.g. Documentary, Feature Film, Cartoon, Music Video, Music, Sound FX, etc.;;Classification\n"
    ...
    "Keywords;;;Y YTY;;;Keywords to the item separated by a comma, used for searching.;;Classification\n"
    "Summary;;;Y YTY;;;A plot outline or a summary of the story.;;Classification\n"
    "Synopsis;;;Y YTY;;;A description of the story line of the item.;;Classification\n"
    ...
    "Released_Date;;;Y YTY;;;The date/year that the item was released.;;Temporal\n"
    "Original/Released_Date;;;Y YTY;;;The date/year that the item was originaly released.;;Temporal\n"
    "Recorded_Date;;;Y YTY;;;The time/date/year that the recording began.;;Temporal\n"
    "Encoded_Date;;;Y YTY;;;The time/date/year that the encoding of this item was completed began.;;Temporal\n"
    "Tagged_Date;;;Y YTY;;;The time/date/year that the tags were done for this item.;;Temporal\n"
    "Written_Date;;;Y YTY;;;The time/date/year that the composition of the music/script began.;;Temporal\n"
    "Mastered_Date;;;Y YTY;;;The time/date/year that the item was tranfered to a digitalmedium.;;Temporal\n"
    "File_Created_Date;;;N NTY;;;The time that the file was created on the file system;;Temporal\n"
    "File_Created_Date_Local;;;N NTY;;;The time that the file was created on the file system (Warning: this field depends of local configuration, do not use it in an international database);;Temporal\n"
    "File_Modified_Date;;;N NTY;;;The time that the file was modified on the file system;;Temporal\n"
    "File_Modified_Date_Local;;;N NTY;;;The time that the file was modified on the file system (Warning: this field depends of local configuration, do not use it in an international database);;Temporal\n"
    "Recorded_Location;;;Y YTY;;;Location where track was recorded. (See COMPOSITION_LOCATION for format);;Spatial\n"
    "Written_Location;;;Y YTY;;;Location that the item was originaly designed/written. Information should be stored in the following format: country code, state/province, city where the coutry code is the same 2 octets as in Internet domains, or possibly ISO-3166. e.g. US, Texas, Austin or US, , Austin.;;Spatial\n"
    "Archival_Location;;;Y YTY;;;Location, where an item is archived, e.eg. Louvre,Paris,France;;Spatial\n"
    ...
    "Dimensions;;;Y YTY;;;Specifies the size of the original subject of the file. eg 8.5 in h, 11 in w;;Technical\n"
    "DotsPerInch;;;Y YTY;;;Stores dots per inch setting of the digitizer used to produce the file;;Technical\n"
    "Lightness;;;Y YTY;;;Describes the changes in lightness settings on the digitizer required to produce the file;;Technical\n"
    ...
    "OriginalSourceForm/Cropped;;;Y YTY;;;Describes whether an image has been cropped and, if so, how it was cropped. e.g. 16:9 to 4:3, top and bottom;;Technical\n"
    "OriginalSourceForm/Sharpness;;;Y YTY;;;Identifies the changes in sharpness for the digitizer requiered to produce the file;;Technical\n"
    "Tagged_Application;;;Y YTY;;;Software used to tag this file;;Technical\n"
    ...
    "Producer_Copyright;;;Y YTY;;;The copyright information as per the productioncopyright holder.;;Legal\n"
    ...
    "Cover_Data;;;N YTY;;;Cover, in binary format encoded BASE64;;Info\n"
    ...
    "Played_First_Date;;;Y YTY;;;The date, the owner first played an item;;Personal\n"
    "Played_Last_Date;;;Y YTY;;;The date, the owner last played an item;;Personal\n"
...
void MediaInfo_Config_Video (ZtringListList &Info)
{
    ...
    "DolbyVision/String;;;Y NTN;;;Dolby Vision info\n"
    "DolbyVision_Version;;;N YTY;;;Dolby Vision version\n"
    "DolbyVision_Profile;;;N YTY;;;Dolby Vision profile\n"
    "DolbyVision_Level;;;N YTY;;;Dolby Vision level\n"
    "DolbyVision_Layers;;;N YTY;;;Dolby Vision layers\n"
