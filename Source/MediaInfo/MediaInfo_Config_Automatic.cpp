...
void MediaInfo_Config_Text (ZtringListList &Info)
{
    ...
    "Events_MinDuration/String;;;Y NT;;;Minimum duration per event (formated)\n"
    "Events_MinDuration/String1;;;N NT;;;Minimum duration per event in format : HHh MMmn SSs MMMms, XX omited if zero\n"
    "Events_MinDuration/String2;;;N NT;;;Minimum duration per event in format : XXx YYy only, YYy omited if zero\n"
    "Events_MinDuration/String3;;;N NT;;;Minimum duration per event in format : HH:MM:SS.MMM\n"
    "Events_MinDuration/String4;;;N NT;;;Minimum duration per event in format : HH:MM:SS:FF, last colon replaced by semicolon for drop Duration;; ms;N YFY;;;Play time of the stream, in ms\n"
