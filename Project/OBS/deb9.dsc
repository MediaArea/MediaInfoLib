...
Build-Depends: debhelper (>= 9), dpkg-dev (>= 1.16.1), python-all (>= 2.6.6-3~), python3-all, dh-python, dh-autoreconf, doxygen, tofrodos, libzen-dev (>= 0.4.40), libcurl4-gnutls-dev, libmms-dev, libglib2.0-dev, zlib1g-dev, pkg-config
Package-List:
